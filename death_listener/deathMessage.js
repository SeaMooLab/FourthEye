...
export function setupDeathListener(bot, channelId) {
    bot.on("text", (packet) => {
...
function getDeathReason(message, parameter) {
    const deathReasons = {
...
function getMobDeathReason(entity) {
    const mobDeathReasons = {
...
function sendDeathMessage(channelId, playername, reason) {
